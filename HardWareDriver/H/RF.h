...
#define         PAYLOAD_WIDTH                  7				//Payload宽度：     8bytes				
#define         TRANSMIT_TYPE                  TRANS_BURST_MODE//TRANS_BURST_MODE 		//使用增强型模式           TRANS_BURST_MODE    TRANS_ENHANCE_MODE
#define         DATA_RATE                      DR_250K                            //通信速率250Kbps            DR_2M    DR_1M
